...
procedure TFoficinanew.Button1Click(Sender: TObject);
var errores: String;
begin
  errores := '';
...
procedure TFoficinanew.Edit1KeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [VKUP, VKDOWN, VKLEFT, VKRIGHT, VKBACK, VKDELETE, VKTAB])or(KeyChar in ['0'..'9']) then else Abort;
end;

procedure TFoficinanew.Edit2ChangeTracking(Sender: TObject);
begin
...
procedure TFoficinanew.Edit2KeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
procedure TFoficinanew.Edit3ChangeTracking(Sender: TObject);
begin
...
procedure TFoficinanew.EditButton1Click(Sender: TObject);
begin
...
procedure TFoficinanew.EditButton2Click(Sender: TObject);
begin
...
procedure TFoficinanew.FormKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if Key = VKEscape then Close;
end;

procedure TFoficinanew.SpeedButton12Click(Sender: TObject);
begin
...
procedure TFoficinanew.SpeedButton2Click(Sender: TObject);
begin
  Close;
end;

...
procedure TFtramitenew.Button1Click(Sender: TObject);
var errores: String;
begin
  errores := '';
...
procedure TFtramitenew.Edit2ChangeTracking(Sender: TObject);
begin
...
procedure TFtramitenew.Edit2KeyUp(Sender: TObject; var Key: Word;
...
procedure TFtramitenew.EditButton1Click(Sender: TObject);
begin
...
procedure TFtramitenew.FormKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if Key = VKEscape then Close;
end;

procedure TFtramitenew.SpeedButton12Click(Sender: TObject);
begin
...
procedure TFtramitenew.SpeedButton2Click(Sender: TObject);
begin
  Close;
end;

...
procedure TFunidadnew.Button1Click(Sender: TObject);
var errores: String;
begin
  errores := '';
...
procedure TFunidadnew.Edit1KeyDown(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if (Key in [VKUP, VKDOWN, VKLEFT, VKRIGHT, VKBACK, VKDELETE, VKTAB])or(KeyChar in ['0'..'9']) then else Abort;
end;

procedure TFunidadnew.Edit2ChangeTracking(Sender: TObject);
begin
...
procedure TFunidadnew.Edit2KeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
...
procedure TFunidadnew.EditButton1Click(Sender: TObject);
begin
...
procedure TFunidadnew.FormKeyUp(Sender: TObject; var Key: Word;
  var KeyChar: Char; Shift: TShiftState);
begin
  if Key = VKEscape then Close;
end;

procedure TFunidadnew.SpeedButton12Click(Sender: TObject);
begin
...
procedure TFunidadnew.SpeedButton2Click(Sender: TObject);
begin
  Close;
end;

...
var
  Ffuncionarionew: TFfuncionarionew;
...
procedure TFfuncionarionew.Button1Click(Sender: TObject);
var errores: String;
begin
  errores := '';
  ...
  begin
    ...
    mitramitedm.funcionarios.Insert;
...
procedure TFfuncionarionew.Edit1ChangeTracking(Sender: TObject);
begin
...
procedure TFfuncionarionew.Edit1KeyDown(Sender: TObject; var Key: Word;
...
procedure TFfuncionarionew.Edit2ChangeTracking(Sender: TObject);
begin
...
procedure TFfuncionarionew.Edit3ChangeTracking(Sender: TObject);
begin
  if Edit3.Text<>'' then
...
procedure TFfuncionarionew.EditButton1Click(Sender: TObject);
begin
...
procedure TFfuncionarionew.EditButton2Click(Sender: TObject);
begin
...
procedure TFfuncionarionew.EditButton3Click(Sender: TObject);
begin
  Fitemnew.Edit1.Text := '';
  Fitemnew.Memo1.Text := '';
...
procedure TFfuncionarionew.SpeedButton12Click(Sender: TObject);
begin
...
procedure TFfuncionarionew.SpeedButton2Click(Sender: TObject);
begin
  Close;
end;
